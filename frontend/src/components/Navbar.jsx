      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <NavLink to="/" className="flex items-center gap-3 group">
            <div className="w-11 h-11 bg-gradient-to-br from-[#1a4d2e] to-[#2d5a3c] rounded-xl flex items-center justify-center text-white font-bold text-2xl group-hover:rotate-6 transition-all shadow-lg shadow-green-900/20">
              D
            </div>
