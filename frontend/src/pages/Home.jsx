  ...
  return (
    <div className="bg-white overflow-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center pt-10 pb-20 px-6">
        ...
        <div className="absolute top-20 right-[-10%] w-125 h-125 bg-green-50 rounded-full blur-[120px] opacity-60 z-0 animate-pulse"></div>
        <div className="absolute bottom-20 left-[-10%] w-100 h-100 bg-orange-50 rounded-full blur-[100px] opacity-60 z-0"></div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-[#1a4d2e] rounded-[60px] p-12 md:p-24 text-white relative overflow-hidden shadow-2xl">
            <div className="absolute top-0 right-0 w-1/2 h-full bg-linear-to-l from-black/20 to-transparent"></div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 grid grid-cols-2 gap-4">
              <img src="/public/Farm2.jpg" alt="Farm" className="rounded-3xl h-64 w-full object-cover shadow-lg" />
              <img src="/public/Farm.jpg" alt="Farm" className="rounded-3xl h-64 w-full object-cover shadow-lg mt-8" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mb-20">
        <h1 className="text-lg md:text-2xl font-bold text-green-900 mb-3 mt-3 text-center">Frequently Asked Questions  </h1>
