  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-24 overflow-hidden bg-white">
        <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 w-150 h-150 bg-green-50 rounded-full blur-3xl opacity-50"></div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              ...
              <div className="flex gap-4">
                <div className="flex -space-x-4 overflow-hidden">
                  {[1,2,3,4].map(i => (
                    <div key={i} className="inline-block h-10 w-10 rounded-full ring-2 ring-white bg-green-200"></div>
                  ))}
                </div>
            ...
            <div className="lg:w-1/2">
              <div className="relative">
                ...
                <img 
                  src="/public/AboutImg2.avif" 
                  alt="Agriculture" 
                  className="rounded-3xl shadow-2xl relative z-10 w-full object-cover h-100"
                />
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-[#1a4d2e] rounded-[50px] overflow-hidden shadow-2xl relative">
            ...
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="h-100 lg:h-auto overflow-hidden bg-black">
                <img 
                  src="/public/AboutImg.avif"
